					...
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="name" id="name" required lay-verify="required" placeholder="联系人" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="phone" id="phone" required lay-verify="required|phone" placeholder="手机号码" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
						...
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px"  name="address" id="address" required lay-verify="required" placeholder="选择地址" autocomplete="off"
								 class="layui-input">
							</div>
						</div>
