                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    ...
                                    <div class="ng-prslist-tit" ><span style="color: red;" @click="deleteJiudianCollection(item.id)">删除 {{item.jiudianName}} 收藏</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jiudianCollectionContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jiudianCollectionContent: function(val) {
                if (val) {
