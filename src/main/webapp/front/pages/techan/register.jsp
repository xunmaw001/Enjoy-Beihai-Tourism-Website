              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">特产名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="techanName" id="techanName"  placeholder="特产名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">特产类型:</span>
                        <div class="layui-input-inline">
                            <select name="techanTypes" id="techanTypes" lay-filter="techanTypes" style="width: 600px;">
