...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jiudianLiuyanContent != null && ruleForm.jiudianLiuyanContent != 'null' && ruleForm.jiudianLiuyanContent != '') {
            ...
            jiudianLiuyanContentUeditor.ready(function () {
                var mes = '';
                if(ruleForm.jiudianLiuyanContent != null){
                    mes = ''+ ruleForm.jiudianLiuyanContent;
                    mes = mes.replace(/\n/g, "<br>");
                }
    ...
    function readonly() {
        ...
        if(window.sessionStorage.getItem('addjiudianLiuyan') != null && window.sessionStorage.getItem('addjiudianLiuyan') !=""){//新增查询,修改不查
            // 查询当前登录账户的信息
            var userId = window.sessionStorage.getItem('userId');
